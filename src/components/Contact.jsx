...
const Contact = () => {
    return (
        <div
            name="contact" className="w-full min-h-screen bg-gradient-to-b from-zinc-800 via-neutral-900 to-neutral-900 text-white p-4">
            <div
                ...
                <div
                    ...
                    <p
                    className="py-5">Submit this form to get in touch with me.</p>
                </div>
                <div
                className="flex justify-center items-center">
                    <form action="https://getform.io/f/ae8359e7-abec-4c4e-8175-757b6eca4c5b" method="POST"
